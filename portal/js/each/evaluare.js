...
<form>
   ...
   <input type="radio" id="Da1"  name="arie_comepetenta" value="Da">        <label for="Da1">Da</label>        <br>        <input type="radio" id="Nu1" name="arie_comepetenta" value="Nu">        <label for="Nu1">Nu</label>        
   <h4>Este titlul articolului clar, informativ  și conform propunerii pe care o anunță?</h4>
   <input type="radio" id="Da2"  name="conformitate_titlu" value="Da">        <label for="Da2">Da</label>        <br>        <input type="radio" id="Nu2" name="conformitate_titlu" value="Nu">        <label for="Nu2">Nu</label>        
   <h4>Rezumatul poate fi considerat complet?</h4>
   <input type="radio" id="Da3"  name="completitudine_rezumat" value="Da">        <label for="Da3">Da</label>        <br>        <input type="radio" id="Nu3" name="completitudine_rezumat" value="Nu">        <label for="Nu3">Nu</label>        
   <h4>Cuvintele cheie sunt adecvate propunerii de articol?</h4>
   <input type="radio" id="Perfect adecvate"  name="cuv_cheie_adecvate" value="Perfect adecvate">        <label for="Perfect adecvate">Perfect adecvate</label>        <br>        <input type="radio" id="Suficient de adecvate" name="cuv_cheie_adecvate" value="Suficient de adecvate">        <label for="Suficient de adecvate">Suficient de adecvate</label>        <br>        <input type="radio" id="Parțial adecvate"  name="cuv_cheie_adecvate" value="Parțial adecvate">        <label for="Parțial adecvate">Parțial adecvate</label>        <br>        <input type="radio" id="Insuficient adecvate" name="cuv_cheie_adecvate" value="Insuficient adecvate">        <label for="Insuficient adecvate">Insuficient adecvate</label>        <br>        
   <h4>Originalitatea conținutului?</h4>
   <input type="radio" id="Complet original"  name="originalitate" value="Complet original">        <label for="Complet original">Complet original</label>        <br>        <input type="radio" id="original2" name="originalitate" value="Idei originale imbricate într-un text care sintetizează teorii arhicunoscute, inedită interpretare a corpusului">        <label for="original2">Idei originale imbricate într-un text care sintetizează teorii arhicunoscute, inedită interpretare a corpusului</label>        <br>        <input type="radio" id="original3" name="originalitate" value="Modeste elemente de originalitate: reproducere a unor idei comune, sinteză a punctelor de vedere teoretice urmată de o analiză de corpus">        <label for="original3">Modeste elemente de originalitate: reproducere a unor idei comune, sinteză a punctelor de vedere teoretice urmată de o analiză de corpus</label>        <br>        <input type="radio" id="original4" name="originalitate" value="Lipsit de originalitate">        <label for="original4">Lipsit de originalitate</label>        
   <h4>Actualitatea și relevanța cercetării relatate în acest articol?</h4>
   <input type="radio" id="actualitate1"  name="actualitate" value="Perfect actuală și relevantă">        <label for="actualitate1">Perfect actuală și relevantă</label>        <br>        <input type="radio" id="actualitate2" name="actualitate" value="Actuală și suficient de relevantă">        <label for="actualitate2">Actuală și suficient de relevantă</label>        <br>        <input type="radio" id="actualitate3" name="actualitate" value="Parțial relevantă, nonactuală">        <label for="actualitate3">Parțial relevantă, nonactuală</label>        <br>        <input type="radio" id="actualitate4" name="actualitate" value="Lipsă de relevanță și de actualitate">        <label for="actualitate4">Lipsă de relevanță și de actualitate</label>        
   <h4>Coerența și argumentația </h4>
   <input type="radio" id="fb1"  name="coerenta" value="Foarte bine">        <label for="fb1">Foarte bine</label>        <br>        <input type="radio" id="b1" name="coerenta" value="Bine">        <label for="b1">Bine</label>        <br>        <input type="radio" id="s1" name="coerenta" value="Suficient">        <label for="s1">Suficient</label>        <br>        <input type="radio" id="i1" name="coerenta" value="Insuficient">        <label for="i1">Insuficient</label>        
   <h4>Limba și calitatea redactării  </h4>
   <input type="radio" id="fb2"  name="redactare" value="Foarte bine">        <label for="fb2">Foarte bine</label>        <br>        <input type="radio" id="b2" name="redactare" value="Bine">        <label for="b2">Bine</label>        <br>        <input type="radio" id="s2" name="redactare" value="Suficient">        <label for="s2">Suficient</label>        <br>        <input type="radio" id="i2" name="redactare" value="Insuficient">        <label for="i2">Insuficient</label>        
   <h4>Structura, planul și organizarea textului </h4>
   <input type="radio" id="fb3"  name="structura" value="Foarte bine">        <label for="fb3">Foarte bine</label>        <br>        <input type="radio" id="b3" name="structura" value="Bine">        <label for="b3">Bine</label>        <br>        <input type="radio" id="s3" name="structura" value="Suficient">        <label for="s3">Suficient</label>        <br>        <input type="radio" id="i3" name="structura" value="Insuficient">        <label for="i3">Insuficient</label>        
   <h4>Claritatea obiectivelor expuse </h4>
   <input type="radio" id="fb4"  name="obiective" value="Foarte bine">        <label for="fb4">Foarte bine</label>        <br>        <input type="radio" id="b4" name="obiective" value="Bine">        <label for="b4">Bine</label>        <br>        <input type="radio" id="s4" name="obiective" value="Suficient">        <label for="s4">Suficient</label>        <br>        <input type="radio" id="i4" name="obiective" value="Insuficient">        <label for="i4">Insuficient</label>        
   <h4>Fundamentele teoretice </h4>
   <input type="radio" id="fb5"  name="fundamente" value="Foarte bine">        <label for="fb5">Foarte bine</label>        <br>        <input type="radio" id="b5" name="fundamente" value="Bine">        <label for="b5">Bine</label>        <br>        <input type="radio" id="s5" name="fundamente" value="Suficient">        <label for="s5">Suficient</label>        <br>        <input type="radio" id="i5" name="fundamente" value="Insuficient">        <label for="i5">Insuficient</label>        
   <h4>Metoda de cercetare utilizată</h4>
   <input type="radio" id="fb6"  name="cercetare" value="Foarte bine">        <label for="fb6">Foarte bine</label>        <br>        <input type="radio" id="b6" name="cercetare" value="Bine">        <label for="b6">Bine</label>        <br>        <input type="radio" id="s6" name="cercetare"value="Suficient">        <label for="s6">Suficient</label>        <br>        <input type="radio" id="i6" name="cercetare" value="Insuficient">        <label for="i6">Insuficient</label>        
   <h4>Rezultatele cercetării sunt corelate cu obiectivele acesteia</h4>
   <input type="radio" id="fb7"  name="rezultate" value="Foarte bine">        <label for="fb7">Foarte bine</label>        <br>        <input type="radio" id="b7" name="rezultate" value="Bine">        <label for="b7">Bine</label>        <br>        <input type="radio" id="s7" name="rezultate" value="Suficient">        <label for="s7">Suficient</label>        <br>        <input type="radio" id="i7" name="rezultate" value="Insuficient">        <label for="i7">Insuficient</label>        
   <h4>Concluziile reflectă demersul cercetării </h4>
   <input type="radio" id="fb8"  name="concluzii" value="Foarte bine">        <label for="fb8">Foarte bine</label>        <br>        <input type="radio" id="b8" name="concluzii" value="Bine">        <label for="b8">Bine</label>        <br>        <input type="radio" id="s8" name="concluzii" value="Suficient">        <label for="s8">Suficient</label>        <br>        <input type="radio" id="i8" name="concluzii" value="Insuficient">        <label for="i8">Insuficient</label>        
   ...
   <input type="radio" id="fb9"  name="referinte" value="Foarte bine">        
            ...
            if(propunere){
                switch (authorized(propunere)){
                    ...
                    case 1:
                        ...
                        //download prop link
                        var propunereRef = firebase.storage().ref(`${PUB.toUpperCase()}/${propunere.id}-${PUB.toLowerCase()}-${getUserId()}-propunere.doc`);
                        console.log(`${PUB.toUpperCase()}/${propunere.id}-${PUB.toLowerCase()}-${getUserId()}-propunere.doc`)
